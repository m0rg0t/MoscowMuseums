...
namespace M0rg0tRss
{
    ...
    public sealed partial class MapItemsPage : M0rg0tRss.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            {
                RssDataGroup group;
                if ((String)navigationParameter=="touristBestItems") {
                    group = ViewModelLocator.MainStatic.BestItems;
                    this.DefaultViewModel["Group"] = ViewModelLocator.MainStatic.BestItems;
                    this.DefaultViewModel["Items"] = ViewModelLocator.MainStatic.BestItems.Items;
                } else {
                    // TODO: Создание соответствующей модели данных для области проблемы, чтобы заменить пример данных
                    group = ViewModelLocator.MainStatic.GetGroup((String)navigationParameter);
